...
class Team extends Component {
  ...
  render() {
    ...
    var contrilist = contributors.map(contri => {
      return (
        <div class="col-xs-2 lawyer-post g-mb-50 m-2">
          <a href={contri.url}>
            <img
                ...
                <div class="container pt-8 pb-6">
                  ...
                  >
                    ...
                    <div class="col-md-4">
                      <Card style={{ marginBottom: '2vh', border: '0px' }}>
                        <Image
                          src="https://avatars1.githubusercontent.com/u/32647423?s=460&v=4"
                          wrapped
                          ui={false}
                          width={{ maxWidth: '350px' }}
                        />
                        <Card.Content>
                    ...
                    <div class="col-md-4">
                      <Card style={{ marginBottom: '2vh', border: '0px' }}>
                        <Image
                          src="https://avatars1.githubusercontent.com/u/33068322?s=460&v=4"
                          wrapped
                          ui={false}
                        />
                        <Card.Content>
                ...
                >
                  <div class="row">
                    <div class="col-md-4">
                      <Card style={{ marginBottom: '2vh', border: '0px' }}>
                        <Image
                          src="https://avatars0.githubusercontent.com/u/31209617?s=460&v=4"
                          wrapped
                          ui={false}
                        />
                        <Card.Content>
                    ...
                    <div class="col-md-4">
                      <Card style={{ marginBottom: '2vh', border: '0px' }}>
                        <Image
                          src="https://avatars2.githubusercontent.com/u/34160672?s=460&v=4"
                          wrapped
                          ui={false}
                          width={{ maxWidth: '350px' }}
                        />
                    ...
                    <div class="col-md-4">
                      <Card style={{ marginBottom: '2vh', border: '0px' }}>
                        <Image
                          src="https://avatars3.githubusercontent.com/u/43990819?s=460&v=4"
                          wrapped
                          ui={false}
                        />
                        <Card.Content>
