...
const JoinUs = () => {
  return (
    <div>
      <div class="mt-12"></div>
      <div
        class="container content blog-page blog-item"
      ...
      >
          ...
          <section class="container">
            ...
            >
              <a href="http://slack.codeuino.org">
                <img src="https://cdn0.iconfinder.com/data/icons/tuts/256/slack_alt.png" />
              </a>
              <a href="https://github.com/codeuino">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTUGABB70TILWLV3BLkJ0hLr0arXG20T7pGd6czWU7tzdkwdoRV&s" />
              </a>
            </div>
          </section>
        </div>
        ...
        <div className="row">
          ...
          <div className="col-md-8">
            <p
              className="text bold lead text-uppercase"
              style={{ textAlign: 'left' }}
            >
              <b>Join Us</b>
            </p>
            <p className="text" style={{ textAlign: 'left' }}>
              Codeuino is a non - profit organization that helps to bring
        ...
        <div className="row mt-5">
          ...
          <div className="col-md-8">
            <p
              className="text text-uppercase bold lead"
              style={{ textAlign: 'left' }}
            >
              <b>Working with Codeuino</b>
            </p>
            <p className="text" style={{ textAlign: 'left' }}>
          ...
          <div className="col-md-8">
            <blockquote>
              <ul style={{ listStyleType: 'none' }}>
                ...
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>2.</b> Before Solving, leave a comment suggesting your
                  will.
                </li>
                <li className="text" style={{ textAlign: 'left' }}>
                ...
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>5.</b> After the merge is successful, review the pull
                  request.
                </li>
              </ul>
            </blockquote>
            ...
            <p className="text-uppercase" style={{ textAlign: 'left' }}>
            ...
            <p className="text" style={{ textAlign: 'left' }}>
              ...
              <strong>Meeting channel and General channel.</strong>
              <br />
              <br />
              <strong>Meeting chat room</strong> is related to a specific
              details and <strong>General chat room</strong> is related to
            ...
            <blockquote>
              <ul style={{ listStyleType: 'none' }}>
                ...
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>2.</b>It will be appreciated if your Github username and
                  slack username is same which will make easier for all to
                  identify you.
                </li>
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>3.</b>Do not mention users unrelated to a particular
                ...
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>4.</b>Don’t repeatedly mention people in an ongoing
                  conversation.
                </li>
                <li className="text" style={{ textAlign: 'left' }}>
            ...
            <p className="text" style={{ textAlign: 'left' }}>
              ...
              <br />
              <br />
              <strong>Note:-</strong>If you have questions, make sure they are
              precise and have the proper documentation style. You must feel
              free to contact us on Slack while you encounter any problem.
              <br />
              <br />
              Also, we use <strong>Hangouts</strong>, to conduct our discussions
            ...
            <blockquote>
              <ul style={{ listStyleType: 'none' }}>
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>1.</b>We have created a different channel{' '}
                  <strong>#chalk-outProposals</strong> on Slack for our
                ...
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>2.</b>If your project is unanimously accepted by the team
                  then you will be allowed to create issues regarding your
                  project. But until then, you cannot do so.
                </li>
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>3.</b>As soon the project is accepted you will be the
                ...
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>4.</b>Also, you can then label the issue as{' '}
                  <strong>“Work In Progress” (wip)</strong>, so that others do
                  not work on it.
                </li>
              </ul>
            </blockquote>
            ...
            <p className="text" style={{ textAlign: 'left' }}>
              ...
              <br />
              <br />
              <strong>Important !!</strong> You need to be logged in before you
              ...
              <strong>Cloning our GitHub repository:-</strong> The git clone
            ...
            <blockquote>
              <ul style={{ listStyleType: 'none' }}>
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>1.</b>cd path where you would like the clone to create a
                  directory
                </li>
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>2.</b>copy and paste this code into your terminals for
                ...
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>3.</b>Now pick an issue which isn’t assigned and which you
                ...
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>4.</b>
                  <strong>Caution:-</strong> You should never work on an issue
            ...
            <p className="text" style={{ textAlign: 'left' }}>
              ...
              <br />
              <br />
              <strong>Important !!</strong> It is important that you DO NOT make
              ...
              <strong>$ git checkout -b branchname</strong> where your branch
            ...
            <p className="text" style={{ textAlign: 'left' }}>
              ...
              GitHub and clicking New Pull Request. <br />
              <br />
              <strong>Note:-</strong> Comments are always welcomed, as the
              readability of the code becomes easy for the other developers.{' '}
              <br />
              <br />
              <strong>Creating a Pull Request:-</strong> If you've forked a
              repository and made changes to the fork, you can ask that the
              upstream repository accept your changes by creating a pull
              request.
              <br />
              <br />
              <strong>Note:</strong> To open a pull request in a public
            ...
            <blockquote>
              <ul style={{ listStyleType: 'none' }}>
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>1.</b>Navigate to the original repository you created your
                  fork from.
                </li>
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>2.</b>To the right of the Branch menu, click
                ...
                <li className="text" style={{ textAlign: 'left' }}>
                  <b>4.</b>If you do not want to allow anyone with push access
                  to the upstream repository to make changes to your PR,
                  deselect <strong>Allow edits from maintainers.</strong>
                </li>
                <li className="text" style={{ textAlign: 'left' }}>
