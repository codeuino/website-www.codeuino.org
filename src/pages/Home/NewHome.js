                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-12 col-md-7 col-lg-6 order-md-1">
                    ...
                    <p class="lead text-center text-md-left text-muted mb-6 mb-lg-8">
                      We are a Non-Profit Open Source Social Networking
                      organisation that provides various robust frameworks
                      solutions which could span the entire world.
                    </p>
                ...
                >
                  <div class="row">
                    <div class="col-md-6 co-12 ml-0 pt-6 pb-6 pl-8">
                      ...
                      <a
                        href="https://opencollective.com/donut"
                    ...
                    <div class="col-md-6 col-12" id="join">
                      <p>
                        Codeuino is a Non-Profit Open Source Social Networking
                        organisation that provides various robust frameworks
                        solutions which could span the entire world through
                        building all kinds of social environments, discussion
                  ...
                  <div class="row" style={{ textAlign: 'left' }}>
                    <div class="col-md-4 col-12">
                      ...
                      <p>
                        ...
                        solutions which could span the entire world through
                        building all kinds of social environments, discussion
                        portals and collaboration platforms by giving prospectus
                        to various other organisations, users and outreaches to
                        showcase their products in a custom way. This wide
                        social open networking framework organisation is driven
                        by volunteers all over the globe. This helps open source
                        enthusiast to build up various technocratic social wide
                        living software and researching FOSS projects under code
                        survivors and challenging world. Codeuino takes into the
                        house the development of some of the coolest Open Source
                        Projects that are made with the sole motive to benefit
                        more and more people present all over the world..
                      </p>
                    </div>
                    <div class="col-md-4 col-12">
                      <span
                      ...
                      <h2>Who we Are?</h2>
                      <p>
                        We are a group of young open-source contributors
                        creatively leveraging our expertise in Social networking
                        and development projects to improve the quality of
                        outreaching, interaction and collaboration for the
                        people in developing nations. We consist of various
                        teams from Development, Documentation, Designers and
                        Donut Platform. Everyone at Codeuino contributes to
                        increase efficiency, outreaching for the user and
                        expedite idea generation for social networking.
                      </p>
                    </div>
                    <div class="col-md-4 col-12">
                      <span
                      ...
                      <h2>What do we do?</h2>
                      <p>
                        Codeuino takes into the house the development of some of
                        the coolest Open Source Projects that are made with the
                        sole motive to benefit more and more people present all
                        over the world.
                      </p>
                      <p>
                        Teams within organization design and develop some basic
                        set of software and networking plugins to help
                      ...
                      <p>
                        ...
                        organisations to build up the social environment for
                        their organisation to showcase their products and
                        services for their community along with the
                        collaboration platform to interact with one another.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-12 col-md-10 col-lg-10 text-center">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-12">
                        <h1>Donut</h1>
                        <p>
                          Donut is an open-source, feature-rich, highly flexible
                          and privacy-friendly, social networking platform built
                          for community-oriented collaboration in a customized
                          way. It has been built on the Node.js framework
                          allowing an essential impetus to provide custom and
                          friendly rich widgets and an expansive library of
                          modules to make communication and collaboration easy
                          and successful. With a powerful module system, you can
                          customize this platform by using third party tools,
                          writing your own or integrating other software.
                        </p>
                        <div
                          class="container"
                          style={{
                      ...
                      <div class="col-md-6 col-12">
                        <h1>Codebadge</h1>
                        <p>
                          Codebadge is an open-source, user-friendly,
                          visual-oriented collaboration tool which incorporates
                          development of badges and integrating with forums in a
                          customized way. Codebadge communicate skills,
                          achievements and contribution tracking by providing
                          visual symbols of accomplishments packed with
                          verifiable data and evidence that can be shared across
                          the web. It is a standard organization-oriented
                          project that provides an essential impetus to Admins
                          and users with an appropriate dashboards.
                        </p>
                        <div
                          class="container"
                          style={{
                              ...
                              <div class="col-md-7">
                                <div class="card-body py-7 py-md-9">
                                  ...
                                  <p class="text-muted mb-0">
                                    To all the designers in the world something
                                    big is comming soon! Update your tools for
                                    the battle.
                                  </p>
                                </div>
                              </div>
              ...
              <div class="container">
                ...
                >
                  ...
                  >
                    <Card.Img
                      variant="top"
                      src="https://1.bp.blogspot.com/-Ig-v1tDXZt4/XDODmZvWp1I/AAAAAAAAB0A/KtbFdBPFVQw2O15FekkIR0Yg8MUp--rngCLcBGAs/s1600/GCI%2B-%2BVertical%2B-%2BGray%2BText%2B-%2BWhite%2BBG.png"
                    />
                    <Card.Body>
                      <Card.Title>
                        <h3>Google CodeIN 2019-20</h3>
                      </Card.Title>
                      <Card.Text>Competition for preschool.</Card.Text>
                      <a
                        href="/#/gci19"
                        class="shadow lift mr-1"
                        style={{ color: '#22247A' }}
                      >
                        <u>Read More</u>
                      </a>
                  ...
                  >
                    <Card.Img
                      variant="top"
                      src="https://cdn.shortpixel.ai/spai/q_lossy+ret_img/https://numfocus.org/wp-content/uploads/2017/03/vertical-gsoc-logo_1-1.jpg"
                    />
                    <Card.Body>
                      <Card.Title>
                  ...
                  >
                    <Card.Img
                      variant="top"
                      src="http://codeuino.org/assets/img-temp/activities/wwc.jpg"
                    />
                    <Card.Body>
                      <Card.Title>
                        <h3>
                          ORGANISED A WORKSHOP/ EVENT AT NEW DELHI TOGETHER WITH
                          WOMEN WHO CODE
                        </h3>
                      </Card.Title>
                      <Card.Text>
                  ...
                  >
                    <Card.Img
                      variant="top"
                      src="http://codeuino.org/assets/img-temp/activities/kwoc.png"
                    />
                    <Card.Body>
                      <Card.Title>
                        <h3>Kharagpur Winter of Code 2019</h3>
                      </Card.Title>
                      <Card.Text>
                        Competition for undergraduate students.
                      </Card.Text>
