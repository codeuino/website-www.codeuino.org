    ...
    return (
        <div className="container">
            <div class="row">
                ...
                <Container className="col-lg-6 col-12" style={{paddingTop:"8%",paddingBottom:"12%",textAlign:"left"}}>
                ...
                <Container className="col-lg-0 col-12" id="whycodeuino" style={{paddingTop:"8%",paddingBottom:"12%"}} >
                    <Image src={whycodeuino}  alt="why codeuino"/>
                </Container>
            </div>
        </div>
